const sequenceData = [
    { heading: 'One morning, the human brain woke up ready to tackle the day but immediately forgot where it left its keys.' ,body:''},
    { heading: ' In panic, it sent out an emergency signal to the body, but the eyes were busy staring at the fridge, and the feet were heading straight for a snack..',body:''},
    { heading: 'Trying to multitask, the brain got distracted by a random thought like, "Why do we drive on parkways and park on driveways?" ',body:''},
    { heading: 'After a few moments of confusion, the brain gave up, grabbed a cup of coffee, and said, "Who needs keys anyway?" ' ,body:''},
    {heading :' It finally solved the meaning of life—by Googling it',body:''},
  ];
