const sequenceData = [
    { heading: 'One day, the teacher told Timmy, "You need to give a presentation, and the ppt should be done by you!" ' ,body:''},
    { heading: 'Timmy, being the clever student he was, decided to generate the entire presentation using Gamma.',body:'' },
    { heading: ' He quickly uploaded the slides and confidently went to the class. ',body:'' },
    { heading: ' As soon as he started presenting, the teacher noticed something strange. ' ,body:''},
    { heading :' At the bottom of each slide, in big letters, it said, "Made with Gamma." Timmy froze.',body:''},
    { heading: 'The teacher smiled, "I think Gamma did more work than you did!"',body:''},
  ];
