const sequenceData = [
    { heading: ' As the Titanic sank, Jack tried climbing onto the door, but it tipped over.' , body:''},
    { heading: ' Frustrated, he said, “Rose, scoot over. This door is enormous!”' ,body:'' },
    { heading: ' Rose hesitated, saying, “But what if we both sink?”',body:'' },
    { heading: ' Jack sarcastically replied, “Well, it’s either that or I turn into a popsicle.”',body:'' },
    {heading:'They both climbed on successfully, and the Titanic staff later found them drifting, eating crackers and sharing laughs about their “near-death spa adventure.”' , body:''},
